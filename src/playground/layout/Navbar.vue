...
onMounted(() => {
    ...
    applyDark(saved ? saved === "dark" : window.matchMedia("(prefers-color-scheme: dark)").matches);
});
</script>

<template>
    <header class="vibe-ui-navbar sticky top-0 z-30 h-14 border-b border-gray-100 bg-white/80 backdrop-blur">
        <div class="mx-auto flex h-full max-w-350 items-center justify-between px-5">
            <div class="flex items-center gap-3">
                <div class="flex items-center gap-2">
                    <span class="text-sm font-semibold text-gray-900"> Vibe UI </span>
                </div>
            ...
            <div class="flex items-center gap-1">
                ...
                <a
                    ...
                    <svg viewBox="0 0 16 16" fill="currentColor" aria-hidden="true" class="h-4.5 w-4.5">
                        <path

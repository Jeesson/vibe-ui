...
const doc = docs.popover;
const source =
    '<Popover title="Заголовок"><template #trigger><Button variant="secondary">Открыть Popover</Button></template>Любой контент внутри попапа.</Popover>';
</script>

<template>
    <ComponentDoc :doc="doc" structured-examples>
        <template #examples>
            <DocExample title="Popover с триггером" :source="source">

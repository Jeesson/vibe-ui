...
const { open, triggerRef, rect, openPanel, closePanel } = useFloatingPanel("vibe-ui-autocomplete-panel", 240);
    ...
    <div class="w-full text-sm">
        ...
        <Teleport to="body">
            <ul
                ...
                <li v-for="item in filtered" :key="item" class="cursor-pointer px-3 py-2 hover:bg-gray-50" @click="select(item)">
                    {{ item }}
                </li>
            </ul>
        </Teleport>

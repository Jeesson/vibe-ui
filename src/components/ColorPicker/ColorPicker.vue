...
const { open, triggerRef, rect, togglePanel } = useFloatingPanel("vibe-ui-colorpicker-panel", 180, 208);

const presets = ["#185FA5", "#10B981", "#F59E0B", "#EF4444", "#8B5CF6", "#111827"];
...
<template>
    <div class="inline-block">
        ...
        <Teleport to="body">
            <div
                v-if="open && rect"
                class="vibe-ui-colorpicker-panel fixed z-70 w-52 rounded-md border border-gray-200 bg-white p-3 shadow-lg"
                :style="{
                    top: rect.top + 'px',
                    left: rect.left + 'px',
